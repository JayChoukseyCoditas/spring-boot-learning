...
public class UserControllerTests {
    ...
    public void registerUserWithInternalServerErrorFail() throws Exception{
        ...
        // Mock userService.registerUser to return an exception response
    ...
    public void registerUserWithInvalidInputFail() throws Exception{
        // Prepare a valid UserDto request body with no name and invalid email
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/user/new")
                ...
                // Verify that the response body has correctly defined errors
